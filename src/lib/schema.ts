...
export const bodyMetricSchema = z.object({
  ...
  chest: z.number().min(0).max(500).nullable().optional(),
  arm_left: z.number().min(0).max(500).nullable().optional(),
  arm_right: z.number().min(0).max(500).nullable().optional(),
  waist: z.number().min(0).max(500).nullable().optional(),
  hip: z.number().min(0).max(500).nullable().optional(),
  thigh: z.number().min(0).max(500).nullable().optional(),
