...
export default function GlobalLoading() {
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-6 sm:px-6 md:px-8 space-y-6 animate-pulse" aria-hidden="true">
      {/* Header Skeleton */}
      <div className="rounded-[2rem] bg-white border border-slate-200/60 p-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto w-full">
        ...
        <div className="col-span-full lg:col-span-2 min-h-[160px] p-6 rounded-[2.5rem] bg-white border border-slate-200/60 flex flex-col sm:flex-row items-center justify-around gap-6 shadow-sm">
          <div className="w-[110px] h-[110px] rounded-[1.8rem] bg-slate-200 shrink-0" />
        ...
        <div className="col-span-full md:col-span-1 min-h-[160px] p-6 rounded-[2.5rem] bg-white border border-slate-200/60 flex flex-col justify-between shadow-sm">
          <div className="space-y-2">
        ...
        <div className="col-span-full min-h-[120px] p-6 rounded-[2.5rem] bg-white border border-slate-200/60 flex items-center justify-between shadow-sm">
          <div className="space-y-2">
            <div className="h-5 w-44 bg-slate-200 rounded-full" />
            <div className="h-3.5 w-56 bg-slate-100 rounded-full" />
          </div>
        ...
        <div className="col-span-full grid grid-cols-2 md:grid-cols-4 gap-6">
          {Array.from({ length: 4 }).map((_, idx) => (
            <div key={idx} className="p-4 rounded-[2rem] bg-white border border-slate-200/60 flex flex-col items-center justify-center gap-2 min-h-[90px] shadow-sm">
