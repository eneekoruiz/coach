      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[160] max-h-[85vh] bg-white border-t border-slate-200/80 rounded-t-[2.5rem] p-6 pb-8 shadow-[0_-10px_40px_rgba(0,0,0,0.06)] flex flex-col pointer-events-auto"
          >
